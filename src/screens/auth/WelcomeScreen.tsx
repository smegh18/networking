...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ navigation }) => {
  ...
  // Use the same stable width logic as ScreenWrapper to prevent layout mismatches
  const width = hookWidth > 0 ? hookWidth : (isWeb ? Dimensions.get('window').width || 1200 : 0);
...
const styles = StyleSheet.create({
  ...
  content: {
    ...
    // Remove paddingTop or set it to a fixed, consistent value
